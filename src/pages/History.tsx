              ...
              <div className="bg-slate-50 p-4 rounded-xl">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className="font-medium text-slate-900">{selectedReport.confidence}%</span>
                  </div>
                </div>
              </div>
              ...
              reports.map((row) => (
                <tr key={row.id} className="hover:bg-slate-50 transition-colors group">
                  ...
                  <td className="px-6 py-4">
                    <span className={`text-xs font-bold px-3 py-1 rounded-full ${row.tumorClass === TumorClass.MALIGNANT ? 'text-red-700 bg-red-100' : 'text-green-700 bg-green-100'
                      }`}>
                      {row.tumorClass}
                    </span>
                  </td>
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2">
                      <div className="w-12 h-1.5 bg-slate-100 rounded-full overflow-hidden">
                        <div className={`h-full ${row.tumorClass === TumorClass.MALIGNANT ? 'bg-red-500' : 'bg-green-500'}`} style={{ width: `${row.confidence}%` }}></div>
                      </div>
